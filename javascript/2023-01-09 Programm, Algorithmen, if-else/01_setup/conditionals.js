...
/**
 * Die if (...)-Anweisung wertet den Ausdruck in den Klammern aus und (wandelt das
 * Ergebnis in einen booleschen Wert um.) prüft ob der String falsy/truthy ist.
 */
...
if (weather === "sunny" || weather === "snowy") {
    ...
    // unerfüllte Fälle werden übersprungen => also weglassen, wenn nicht der Fall!
    const nichtBraunWerden = true;
    ...
    // der default case (Standartfall) => Fallback
    // false case
